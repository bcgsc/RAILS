...
echo Running the minimap2 pipeline in streaming mode. No bam files will be written to disk. To run the other pipelines uncomment line above in the script
./runRAILSminimapSTREAM.sh hsapiens-8.fa reads.fa 250 0.95 0 1 nil /gsc/btl/linuxbrew/bin/samtools
