...
if [ $7 == 'ont' ]; then
   ...
   minimap2 -x map-ont -I50g -N 10 -a -t 48 $1-formatted.fa $2-formatted.fa | samtools view -Sb - > $2_vs_$1_gapfilling.bam

elif [ $7 == 'pacbio' ]; then
   echo Running minimap2 with preset map-pb
   minimap2 -x map-pb -I50g -N 10 -a -t 48 $1-formatted.fa $2-formatted.fa | samtools view -Sb - > $2_vs_$1_gapfilling.bam

else
   echo Running minimap2 with no preset
   minimap2 -I50g -N 10 -a -t 48 $1-formatted.fa $2-formatted.fa | samtools view -Sb - > $2_vs_$1_gapfilling.bam
...
if [ $7 == 'ont' ]; then
   echo Running minimap2 with preset map-ont
   minimap2 -x map-ont -I50g -N 10 -a -t 48 $2_vs_$1_$3_$4_gapsFill-formatted.fa $2-formatted.fa | samtools view -Sb - > $2_vs_$1_scaffolding.bam

elif [ $7 == 'pacbio' ]; then
   echo Running minimap2 with preset map-pb
   minimap2 -x map-pb -I50g -N 10 -a -t 48 $2_vs_$1_$3_$4_gapsFill-formatted.fa $2-formatted.fa | samtools view -Sb - > $2_vs_$1_scaffolding.bam

else
   echo Running minimap2 with no preset
   minimap2 -I50g -N 10 -a -t 48 $2_vs_$1_$3_$4_gapsFill-formatted.fa $2-formatted.fa | samtools view -Sb - > $2_vs_$1_scaffolding.bam
