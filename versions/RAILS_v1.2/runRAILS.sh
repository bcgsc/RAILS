...
#bwa mem -x intractg -a -t24 $1-formatted.fa $2-formatted.fa  | samtools view -Sb - > $2_vs_$1_gapfilling.bam
bwa mem -a -t24 $1-formatted.fa $2-scaftigformatted.fa  | samtools view -Sb - > $2_vs_$1_gapfilling.bam
...
bwa mem -a -t24 $2_vs_$1_$3_gapsFill-formatted.fa $2-formatted.fa | samtools view -Sb - > $2_vs_$1_scaffolding.bam
